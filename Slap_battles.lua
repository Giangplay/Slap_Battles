...
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Giangplay/SB-ok/c98fce941f927352d210f94b5f271b242aa31e17/Ui')))()
local Window = OrionLib:MakeWindow({IntroText = "Slap Battles 👏",Name = "Slap Battles 👏", HidePremium = false, SaveConfig = true, IntroEnabled = true, ConfigFolder = "slap battles"})
...
if not workspace:FindFirstChild("arenaVoid") then
...
Tab22:AddButton({
	Name = "Kick Player [ Yes TP Player ] [ Glove Za Hand ]",
	Callback = function()
...
Tab22:AddButton({
	Name = "Kick Player [ Not TP Player ] [ Glove Za Hand ]",
	Callback = function()
game:GetService("ReplicatedStorage").Erase:FireServer()
wait(0.47)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace.Spot.CFrame * CFrame.new(1022,213.8,1498)
...
Tab22:AddButton({
	Name = "Replica UNO [ Glove Reverse and Replica ]",
	Callback = function()
...
Tab14:AddToggle({
	...
	Default = false,
	Callback = function(Value)
		 _G.ErrorDeathSoundSpam = Value
while _G.ErrorDeathSoundSpam do
