...
SafeSpot.Position = Vector3.new(-25800,100,-1500)
...
OrionLib:MakeNotification({
	...
	Content = "ID: 6403373529 | 11520107397",
	Time = 17
})
...
Tab4:AddButton({
	Name = "TP To SafeSpot",
	Callback = function()
         game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace.Spot.CFrame * CFrame.new(0,20,0)
  	end    
})
...
OrionLib:MakeNotification({
	Name = "[ Diamond ] : "..Time.." Second",
	Content = "3600000 second / Ready and Why",
	Time = 2
})
...
Tab19:AddToggle({
	Name = "Time Diamond 1H [ Get Megarock ]",
	Default = false,
	Callback = function(Diamond)
	local Time = 0
...
Tab4:AddToggle({
	Name = "Get bob [ You Epin Replica ] [ Fast ] [ No Notification ]",
	Default = false,
	Callback = function(bool)
...
Tab4:AddToggle({
	Name = "Get bob [ Spam bob 1/7500 ] [ Auto E ]",
	Default = false,
	Callback = function(ReplicaAutoE)
	local Time = 0
	
		Timer = ReplicaAutoE

      if ReplicaAutoE == true then
...
OrionLib:MakeNotification({
	Name = "[ Replica ] : "..Time.."/7500",
	Content = "1/7500 Not old / Spam bob",
	Time = 2
})
...
Tab4:AddToggle({
	Name = "Get bob [ Spam bob 1/7500 ] [ Fast ]",
	Default = false,
	Callback = function(ReplicaFast)
	local Time = 0
	
		Timer = ReplicaFast

      if ReplicaFast == true then
...
Tab11:AddTextbox({
	Name = "view player health [ On Console ]",
	Default = "Name Player",
	TextDisappear = true,
	Callback = function(Value)
...
Tab11:AddBind({
	Name = "Kick Player [ Epin Za Hando ] [ Inconsistent ] [ keybroad ]",
...
Tab14:AddToggle({
	...
	Default = false,
	Callback = function(Value)
         _G.SpamDeathError = Value
while _G.SpamDeathError do
...
Tab15:AddToggle({
	Name = "Auto spam Phantom",
	Default = false,
	Callback = function(Value)
		_G.PhanTomSpam = Value
while _G.PhanTomSpam do
game:GetService("ReplicatedStorage").PhantomDash:InvokeServer(game:GetService("Players").LocalPlayer.Character.Phantom)
wait(3.2)
end
	end    
})
