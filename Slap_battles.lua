...
Tab20:AddButton({
	Name = "Edgelord [ Glove Killstreak ]",
	Callback = function()
pcall(function()
...
Tab14:AddToggle({
	Name = "Auto Spam thanos [ glove thanos ]",
	Default = false,
	Callback = function(bool)
...
Tab14:AddToggle({
	Name = "Auto Spam sleep [ glove ZZZZZZZ ]",
	Default = false,
	Callback = function(bool)
